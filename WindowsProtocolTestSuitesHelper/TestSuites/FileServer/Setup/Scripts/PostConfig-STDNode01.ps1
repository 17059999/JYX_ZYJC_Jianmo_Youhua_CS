...
Function Prepare()
{
    .\Write-Info.ps1 "Executing [PostScript-STDNode01.ps1] ..." -ForegroundColor Cyan
    ...
    $LogPath     = "$WorkingPath\PostConfig-STDNode01.ps1.log"
    try{
...
Function Phase1
{
    ...
    if((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
        ...
        .\Write-Info.ps1 "Set step and then join domain..."
        .\RestartAndRun.ps1 -ScriptPath $CurrentScriptPath -PhaseIndicator "-Step 1" -AutoRestart $false

        # Join Domain
        try{
            .\domainjoin.ps1
        }catch{
            .\Write-Info.ps1 "Join domain failed, restart and try again..."
            Restart-Computer -Force
        }

        .\Write-Info.ps1 "Join domain completed..."
    }
...
Function Finish
{
    ...
    .\Write-Info.ps1 "EXECUTE [PostConfig-STDNode01.ps1] FINISHED (NOT VERIFIED)." -ForegroundColor Green
