...
Function Prepare()
{
    .\Write-Info.ps1 "Executing [PostScript-STDDriver.ps1] ..." -ForegroundColor Cyan
    ...
    $LogPath     = "$WorkingPath\PostConfig-STDDriver.ps1.log"
    try{
...
Function Finish
{
    ...
    .\Write-Info.ps1 "EXECUTE [PostConfig-STDDriver.ps1] FINISHED (NOT VERIFIED)." -ForegroundColor Green
