...
Echo Step into [InstallClientToolsC8.bat]       >> %logFile%
...
Echo Source file:  %toolsPath%\mstest\9.0.21206\x86\setup.exe >> %logFile%
%toolsPath%\mstest\9.0.21206\x86\setup.exe /quiet

Echo Start to call SN.exe: >> %logFile%
Echo Source file:  %toolsPath%\mstest\9.0.21206\x86\sn.exe >> %logFile%
%toolsPath%\mstest\9.0.21206\x86\sn.exe /Vr *
...
Echo Source file:  %toolsPath%\PTF\2.1.1218\x86\ProtocolTestFramework.msi >> %logFile%
msiexec /quiet /i  %toolsPath%\PTF\2.1.1218\x86\ProtocolTestFramework.msi
...
Echo Finish to install C8 tools.           >> %logFile%
Echo Step out [InstallClientToolsC8.bat]   >> %logFile%
