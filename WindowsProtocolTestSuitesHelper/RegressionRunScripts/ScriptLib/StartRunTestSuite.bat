...
Echo [RestartAndRun] Run: runTestSuite.bat: %scriptsPath%\RunTestSuite.bat         >> %logFile%
%scriptsPath%\RestartAndRun.bat "%scriptsPath%\RunTestSuite.bat %1 %2 %logFile% %4 %5 %binPath% %toolsPath% %scriptsPath% %testResultsPath% %RSinScope% %RSoutOfScope%"
