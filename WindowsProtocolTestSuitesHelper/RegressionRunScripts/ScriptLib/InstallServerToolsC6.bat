...
Echo Step into [InstallServerToolsC6.bat]        >> %logFile%
...
rem Server does not need to install NetMon...

rem Echo Start to install NetMon:       >> %logFile%
rem Echo Source file: %toolsPath%\NetworkMonitor\3.2.901\%CPUArchitecture%\Netmonpt3.msi >> %logFile%
rem msiexec /quiet /i %toolsPath%\NetworkMonitor\3.2.901\%CPUArchitecture%\Netmonpt3.msi
...
Echo Step out [InstallServerToolsC6.bat]     >> %logFile%
