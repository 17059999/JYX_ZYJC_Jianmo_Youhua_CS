...
%scriptsPath%\RestartAndRun.bat "cmd /C powershell %scriptsPath%\Config-Client.ps1 %toolsPath% %scriptsPath% %binPath% %testResultsPath% %serverOS% %IPVersion% %workgroupDomain% %userNameInVM% %userPwdInVM% %domainInVM%"
