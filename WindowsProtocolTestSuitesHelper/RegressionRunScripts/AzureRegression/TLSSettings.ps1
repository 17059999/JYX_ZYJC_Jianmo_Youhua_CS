# Enforce TLS1.2
# https://aka.ms/TLSScript
# Copied from https://microsoft.sharepoint.com/teams/TLS12Everywhere/SitePages/Scripts.aspx
...
param (
    ...
    [bool]$RebootIfRequired = $false, # changed to false
...
$cipherlist = @()
$cipherlist += "TLS_AES_256_GCM_SHA384"  # (TLS 1.3)
$cipherlist += "TLS_CHACHA20_POLY1305_SHA256"  # (TLS 1.3)
