...
{
    public class DrawingtestTool : DgnElementSetTool
    {
        public int i = 0, k = 0;
        public bool j = true;
        ...
        public DrawingtestTool(pipeBiaogaoType pipeType) : base(0, 0)
        {
            type = pipeType;
        }
        //动态显示
            ...
            try
            {
                ...
                if (j)
                {
                    ...
                    else
                    {
                        ...
                        if (ispipe)
                        {
                            BMECObject bmecob = new BMECObject(iec1);
                            string lineNumber = iec1["LINENUMBER"].StringValue; //管线编号
                            myString = pipeBiaogaoForm.getpipexinxi(bmecob, type, true);
                        }
                        else return true;
