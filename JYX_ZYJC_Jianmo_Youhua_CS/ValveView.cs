...
{
    class ValveView : BaseContainerView
    {
        private static ValveView s_instance = null;
        ...
        public ValveView(AddIn addIn, string toolName) : base(addIn, toolName)
        {
            try
            {
                ValveView.s_instance = this;
            }
            catch
            {
                base.Dispose();
        ...
        public static ValveView Instance
        {
            get
            {
                return ValveView.s_instance;
            }
        }
            ...
            if (customAttributes != null && customAttributes.GetPropertyValue("DIAGRAM_CELL_NAME") != null && customAttributes.GetPropertyValue("CELL_LIBRARY") != null)
            {
                ...
                if (!(cellName == string.Empty) && !(libraryName == string.Empty))
                {
                    ...
                    if (cell_elem != null)
                    {
                        ...
                        System.IntPtr metafileHandle = new IntPtr(cell_elem.DrawToEnhancedMetafile(base.PreviewControl.Width*2, base.PreviewControl.Height, false));
